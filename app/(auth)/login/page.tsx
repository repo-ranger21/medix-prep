      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 p-3 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-all text-white font-medium mb-4 disabled:opacity-50"
          >
          ...
          <div className="relative flex items-center gap-3 mb-4">
            ...
            <span className="text-[#475569] text-sm">or</span>
            <div className="flex-1 h-px bg-white/10" />
          </div>
